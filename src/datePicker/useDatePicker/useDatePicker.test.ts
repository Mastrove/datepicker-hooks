...
describe('useDatePicker', () => {
  ...
  test('should check if date is blocked', () => {
    ...
    const {result} = renderHook(() =>
      useDatePicker({
        startDate: new Date(2019, 3, 1, 0, 0, 0),
        endDate: new Date(2019, 3, 2, 0, 0, 0),
        minDate: new Date(2019, 3, 1, 0, 0, 0),
        maxDate: new Date(2019, 3, 10, 0, 0, 0),
        focusedInput: START_DATE,
        onDatesChange: onDatesChange,
      }),
    )
  ...
  test.each([
    {
      ...
      endDate: null,
      minDate: new Date(2019, 3, 1, 0, 0, 0),
      maxDate: new Date(2019, 3, 28, 0, 0, 0),
      focusedInput: START_DATE,
      minDateRange: 3,
  ...
  test.each([
    {
      ...
      minDate: new Date(2019, 3, 1, 0, 0, 0),
      maxDate: new Date(2019, 3, 30, 0, 0, 0),
    ...
    'should execute onDateSelect callback with exact range selected (minDateRange)',
    ({
      blockedDate,
      minDate,
      maxDate,
  ...
  test.each([
    ...
    'should not select exact range (minDateRange)',
    ({blockedDate, minDate, maxDate, selectedDate}) => {
      const onDatesChange = jest.fn()
      advanceTo(new Date(2019, 2, 27, 0, 0, 0))
      const {result} = renderHook(() =>
        useDatePicker({
...
describe('isDateBlocked', () => {
  const minDate = new Date(2019, 2, 10, 1, 0, 0)
  const maxDate = new Date(2019, 2, 27, 1, 0, 0)
  ...
  test('should be blocked', () => {
    ...
    expect(
      isDateBlocked({
        ...
        endDate: null,
        minDateRange: 3,
        maxDate: new Date(2019, 2, 26, 0, 0, 0),
  ...
  test('should not be blocked', () => {
    ...
    expect(
      isDateBlocked({
        ...
        endDate: null,
        minDateRange: 2,
        maxDate: new Date(2019, 2, 27, 0, 0, 0),
        date: new Date(2019, 2, 25, 0, 0, 0),
        minDate,
      }),
    ).toBe(false)
